 ...
 * --------------------
 * If thread-local storage is not supported, it can be manually disabled by
 * defining ``UA_NO_THREAD_LOCAL``. This can result in some minor slowdowns. */
#if !defined(UA_NO_THREAD_LOCAL)
